...
🔗 **線上展示**：[https://online-retail-dashboard.streamlit.app](https://online-retail-dashboard.streamlit.app)
...
| 分析 | RFM 模型、線性迴歸（scikit-learn） |
| 視覺化 | Streamlit、matplotlib、seaborn |
